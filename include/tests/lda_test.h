...
write_byte(0x40, &mem, 0x99); // value at zeropage + indX
...
write_byte(0x5678, &mem, 0x89); // value at absolute + indX

write_byte(0x0008, &mem, 0xA1); // LDA (indirect, X)
write_byte(0x0009, &mem, 0x20); // zero page base address
write_byte(0x0020, &mem, 0x00); // low byte zero page + indX
write_byte(0x0021, &mem, 0x80); // high byte
...
write_byte(0x2000, &mem, 0xBB); // value at 0x2003, value at zero page + indY